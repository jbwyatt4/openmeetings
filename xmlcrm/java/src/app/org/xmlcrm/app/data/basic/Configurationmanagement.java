...
public class Configurationmanagement {
	...
	public String addConfByKey(long USER_LEVEL,String CONF_KEY,String CONF_VALUE,int USER_ID,String comment){
	...
	public String updateConfByUID(long USER_LEVEL,int UID,String CONF_KEY,String CONF_VALUE,int USER_ID,String comment){
		...
		if (checkConfLevel(USER_LEVEL)){
	        try {
	            ...
	            int updatedEntities = session.createQuery( hqlUpdate )
	                                .setString("CONF_KEY",CONF_KEY)
	                                .setString("CONF_VALUE",CONF_VALUE)
