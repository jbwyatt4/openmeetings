...
public class StreamService implements IPendingServiceCallback {
	...
	public Long _stopRecordAndSave(IScope scope, String roomrecordingName, RoomClient currentClient){
		try {
...
//		    }
			...
			//make persistent
			Long recording_id_remote = recordingDao.addRecording(newRecordFileName, duration, "", currentClient.getRoom_id(), us, comment, roomRecordingRemote);
