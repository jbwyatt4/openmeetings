...
public class ImportInitvalues {
	...
	public void loadConfiguration(String crypt_ClassName,
		...
		//"smtp.xmlcrm.org"
		cfgManagement.addConfByKey(3, "smtp_server",
				smtpServer, null, "this is the smtp server to send messages");
		//25
		cfgManagement.addConfByKey(3, "smtp_port",
		...
		//"openmeetings@xmlcrm.org"
		cfgManagement.addConfByKey(3, "email_username",
				mailauthname, null, "System auth email username");
		//
		cfgManagement.addConfByKey(3, "email_userpass",
		...
		cfgManagement.addConfByKey(3, "sendEmailWithVerficationCode",
				sendEmailWithVerficationCode, null, "User must activate their account by clicking on the " +
						...
						"to send a EMail.");
		cfgManagement.addConfByKey(3, "default_export_font",
		...
		cfgManagement.addConfByKey(3, "sip.openxg.enable",
				sip_openxg_enable, null, "Enable the OpenXG XML-RPC Gateway through the Wrapper URL");
		
		cfgManagement.addConfByKey(3, "openxg.wrapper.url",
		...
		cfgManagement.addConfByKey(3, "openxg.client.id",
		...
		cfgManagement.addConfByKey(3, "openxg.adminid",
		...
		cfgManagement.addConfByKey(3, "sip.phonerange.start",
				sip_phonerange_start, null, "The first number in the Range of Phone Numbers in national format");
		
		cfgManagement.addConfByKey(3, "sip.phonerange",
				sip_phonerange, null, "Amount of numbers in the Phone Range available");
		
		cfgManagement.addConfByKey(3, "sip.phonerange.currentindex",
				""+0, null, "Number of used Phone Numbers in the sip.phonerange");
		
		cfgManagement.addConfByKey(3, "sip.phonerange.conference.currentindex",
        ...
        cfgManagement.addConfByKey(3, "show.whiteboard.draw.status",
