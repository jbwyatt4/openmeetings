	...
	public Template handleRequest(HttpServletRequest httpServletRequest,
		...
		try {
			...
			//if (user_level > 0) {
				...
				org.openmeetings.app.persistence.beans.basic.Configuration conf = cfgManagement.getConfKey(3L, "screen_viewer");
				...
				if(mode.equals("sharer") && conf != null){
					...
					try{
						...
						if (conf_i == 0) {
							...
							Configuration configuration = cfgManagement.getConfKey(3L, "default.quality.screensharing");
