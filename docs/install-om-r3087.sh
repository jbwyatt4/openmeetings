...
#How to use?
# You need to set the eXecute permission for this script: chmod +x install-om-3087
...
downloads() {
	...
	if [[ -z $SITE || -z $FILE ]]; then
		...
		aptitude install -y mysql-server openoffice.org-headless openoffice.org-writer openoffice.org-calc openoffice.org-impress openoffice.org-draw openoffice.org-math imagemagick gs-gpl libart-2.0-2 libt1-5 libungif4g zip unzip bzip2 subversion git-core checkinstall yasm texi2html libfaac-dev libfaad-dev libmp3lame-dev  libsdl1.2-dev libx11-dev libxfixes-dev libxvidcore4-dev zlib1g-dev libogg-dev sox libvorbis0a libvorbis-dev libgsm1 libgsm1-dev libfaad2-0 flvtool2 ffmpeg lame
		aptitude full-upgrade

		clear
		wget -q http://victor.sartori.eti.br/openmeetings/swftools_0.8.1-2.1_i386.deb
...
<hibernate-configuration>
	...
	<session-factory>
		...
		<property name=\"connection.password\">$MYSQL_OM_USER_PASSWORD</property>
