...
public class UpdateUserSelf extends TestCase {
	...
	public void testUserUpdate(){
		...
		Long updateRes = uService.updateUser(sessionData.getSession_id(),"swagner3", "", "WagnerUp", "SebUp", 22, "StreetUp", "92a", "75UP", 1, "PfUp", "seba.up", 0, "07Up", "07faxUP", "015UP","comment");
	...
	public void testUserUpdateAdmin(){
		...
		Long updateRes = uService.updateUserAdmin(sessionData.getSession_id(), 3 , 3, "swagner3", "", "WagnerUpAdmin", "SebAdminUp", 22, "StreetUp", "92a", "75UP", 1, "PfUp", "seba.up", 0, "07Up", "07faxUP", "015UP", "comment");
