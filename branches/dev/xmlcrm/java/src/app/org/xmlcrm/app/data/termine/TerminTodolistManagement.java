...
//            }	
    ...
    public Termine_Todo_User getUserTodoItem(long USER_LEVEL,int USER_ID,int UID){
...
//            termine_todolist.setUpdatetimeDE(CalenderI.getDatumMili(termine_todolist.getUpdatetime()));                    
    ...
    public Termine_Todo_User saveTodoListItem(long USER_LEVEL,int USER_ID,String description,String name,String Comment,int STATUS_ID,int priority, String  teilnehmer){
    	Termine_Todo_User termine_todo_user = new Termine_Todo_User();
//    	if (checkUserLevel(USER_LEVEL)){
...
//    	}
    ...
    private Termine_Todo_User saveUserItem(String Comment,int OWNER_ID, int TODO_ID, int USER_ID,int priority){
		Termine_Todo_User termine_todo_user = new Termine_Todo_User();
...
//        }  
    ...
    private Termine_Todolist saveListItem(String name, String Comment, String description,String teilnehmer,int STATUS_ID){
		Termine_Todolist termine_todolist = new Termine_Todolist();
...
//        }  
    ...
    public Termine_Todo_User updateTodoListItem(long USER_LEVEL,int USER_ID,int UID,String name, String Comment,int priority,String description,String teilnehmer,int STATUS_ID){
        Termine_Todo_User termine_todo_user = new Termine_Todo_User();
        if (checkUserLevel(USER_LEVEL)){
...
//            }
    ...
    private Termine_Todo_User updateUserItem(int USER_ID,int UID, String Comment,int priority){
...
//        }  
    ...
    private Termine_Todolist updateListItem(int TODO_ID,String name,String Comment, String description,String teilnehmer,int STATUS_ID){
