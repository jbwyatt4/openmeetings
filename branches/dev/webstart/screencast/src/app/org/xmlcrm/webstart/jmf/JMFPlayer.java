...
public class JMFPlayer extends PlayerFrame implements ItemListener,
    ...
    private JMFManager             jmfRegistry = null;
...
//            setPlaceholder ();
	...
	JMFPlayer outer = null;
	public RTPTimer(JMFPlayer outer) {
	    this.outer = outer;
	}
    ...
    private void exportMediaOld () {
	    ...
	    if ( nameUrl != null  &&  nameUrl.length() > 1  &&  closeCapture() ) {
            if ( nameCaptureDeviceAudio != null  ||  nameCaptureDeviceVideo != null ) {
                ...
                dlgSaveAs = new SaveAsDialog ( JMFPlayer.this, dataSource, cfgJMApps );
            }
            else {
                dlgSaveAs = new SaveAsDialog ( JMFPlayer.this, nameUrl, null, cfgJMApps);
            }
	    }
    }
...
//            setPlaceholder();
    ...
    private void captureMedia () {
        ...
        if ( dataSource != null ) {
            ...
            open ( dataSource );
            if ( dataSource != null ) {
                dlgCaptureControls = new CaptureControlsDialog (  JMFPlayer.this, dataSource );
...
//                setPlaceholder ();
    ...
    public static JMFPlayer createNewFrame () {
        int         nIndex;
        Point       point;
        Dimension   dim;
        Dimension   dimScreen;
    ...
    public static void closeAll () {
        ...
        while ( i > 0 ) {
            i--;
            jmStudio = (JMFPlayer) vectorFrames.elementAt ( i );
