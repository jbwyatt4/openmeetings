...
public class AppointmentLogic {
	...
	public List<Appointment> getTodaysAppointmentsForUser(Long userId){
		...
		List<Appointment> points = appointmentDao.getTodaysAppoitmentsbyRangeAndMember(userId); 
...
//				null);				    // Meeting Timer time in seconds
	...
	public void doScheduledMeetingReminder(){
		...
		List<Appointment> points = appointmentDao.getTodaysAppointmentsForAllUsers();
		...
		Long language_id = Long.valueOf(cfgManagement.
