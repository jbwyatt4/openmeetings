...
public class Install extends VelocityViewServlet {
	...
	public Template handleRequest(HttpServletRequest httpServletRequest,
		...
		try {
			...
			ctx.put("APPLICATION_ROOT", getServletContext().getInitParameter("webAppRootKey"));
			...
			if (command == null){
				...
				if (i == 0){
					...
					String url_feed = getServletContext().getInitParameter("url_feed");
					String url_feed2 = getServletContext().getInitParameter("url_feed2");						
