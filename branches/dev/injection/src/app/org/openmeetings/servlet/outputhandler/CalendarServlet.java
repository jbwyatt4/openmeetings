	...
	protected void service(HttpServletRequest httpServletRequest,
		...
		try {
			...
			if (user_level!=null && user_level > 0) {
				...
				List<Appointment> appointements = appointmentLogic.getAppointmentByRange(userToShowId, new Date(starttime.getTimeInMillis()), new Date(endtime.getTimeInMillis()));
