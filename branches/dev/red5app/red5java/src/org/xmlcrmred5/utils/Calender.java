...
public class Calender {
    ...
    public String getTimeMili(long msek){
	...
	public String getDateFormated(int sek){
		SimpleDateFormat sdf = new SimpleDateFormat("dd-MMM-yyyy HH-mm-ss", Locale.ENGLISH);
		Date dateOld = new Date();
		long timeAdv = sek;
		timeAdv*=1000;
    ...
    public String getDateOnly(int sek){
    ...
    public String getDateOnly(Date dateOld){
    ...
    public long ParseDate(int year, int month, int day, int hour, int min){
        long returndate = 0;
        try {
        	String Sday = "";
        	if (day<10){
    ...
    public String getCalenderweek(long msek){
