...
public class Addadminuser extends TestCase{
	...
	public void testAddADminUser() throws Exception{
		...
		long user_id = Usermanagement.getInstance().registerUserInit(new Long(3), 3, 1, 1, "swagner4", "67810", "Wagner", "Sebastian", "seba.wagner@gmail.com", new java.util.Date(), "Bleichstra§e", "92", "fax number", "75173", 1, "Pforzheim", 1, true, null, "phone");
