...
public class ImportInitvalues {
        ...
        public void loadMainMenu(){
                ...
                Navimanagement.getInstance().addMainStructure("backupContent", 18, 367, true, false, 3, "backupContent",6);
    	...
    	public void loadDefaultRooms(){
    		...
    		Roommanagement.getInstance().addRoom(3,"public Video Only Room", 1,"", new Long(16), true,null,
    				270*2+3, 280*2+2, 2, 2,
    				400,
    				false, 276, 2, 592, 660,
    				false, 2, 284, 310, 270);
    		
    		Roommanagement.getInstance().addRoom(3,"public Video And Whiteboard Room", 1,"", new Long(8), true,null,
    				270, 280*2+2, 2, 2,
    				400,
    				true, 276, 2, 280*2+2, 660,
    				false, 2, 284, 310, 270);    		
    		...
    		Roommanagement.getInstance().addRoom(3,"public Audience Room", 2,"", new Long(4), true, null,
    				270, 280, 2, 2,
    				400,
    				true, 276, 2, 592, 660,
    				true, 2, 284, 310, 270);    		
    		
    		long room4 = Roommanagement.getInstance().addRoom(3,"private Audience Room", 2,"", new Long(4), false, null,
    				270, 280, 2, 2,
    				400,
    				true, 276, 2, 592, 660,
    				true, 2, 284, 310, 270);
